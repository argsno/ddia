...
* [第一章：可靠性、可伸缩性和可维护性](ch1.md)
    ...
    * [可维护性](ch1.md#可维护性)
    * [本章小结](ch1.md#本章小结)
* [第二章：数据模型与查询语言](Courses/ddia/ch2.md)
    * [关系模型与文档模型](Courses/ddia/ch2.md#关系模型与文档模型)
    * [数据查询语言](Courses/ddia/ch2.md#数据查询语言)
    * [图数据模型](Courses/ddia/ch2.md#图数据模型)
    * [本章小结](Courses/ddia/ch2.md#本章小结)
* [第三章：存储与检索](ch3.md)
...
4. [第一部分](part-i.md)前言，[ch2](Courses/ddia/ch2.md)校正 by [@jiajiadebug](https://github.com/Vonng/ddia/commits?author=jiajiadebug)
